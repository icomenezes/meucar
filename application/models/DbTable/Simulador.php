...
class Application_Model_DbTable_Simulador extends Zend_Db_Table_Abstract
{

	protected $_name = 'simulador';
	...
	public function getSimuladorAntesDepois($dados){
		
		return $this->fetchAll("antes_depois = ".$dados['antes_depois']);
	
	}
	
	public function getDadosSimulador(){

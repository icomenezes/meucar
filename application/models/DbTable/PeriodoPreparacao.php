...
class Application_Model_DbTable_PeriodoPreparacao extends Zend_Db_Table_Abstract
{
	...
	public function getPeriodoPreparacao(){
		...
		$row->where('pip.id_empresa = '.$_SESSION['sessionUser']['id_empresa']);

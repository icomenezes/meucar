            ...
            this.context.beginPath();
                if (typeof(this.data[i]) == 'number') {
					...
					if(this.Get('res')){
						...
						var total_orcado = this.Get('total_orcado');
							
						if(this.data[i] < (total_orcado - (total_orcado*0.05))){					
									
							this.context.fillStyle = colors[2];
							
						}else{					
							
							if(this.data[i] == total_orcado){
						...
						var orcado = this.Get('chart.orcado');
									
						
						if(this.data[i] < (orcado[i] - (orcado[i]*0.05))){					
									
							this.context.fillStyle = colors[2];
							
						}else{					
						
							if(this.data[i] == orcado[i]){
